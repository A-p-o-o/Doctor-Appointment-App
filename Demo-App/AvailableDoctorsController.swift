...
extension  AvailableDoctorsController : UICollectionViewDelegateFlowLayout,UICollectionViewDataSource,UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let viewController = BookAppointmentController(doctor: doctor, patient: self.patient, startTime: time!, endTime: endAndSlot.endtime, date: dateFormat(date: date!), slotNo: endAndSlot.slotNo)
