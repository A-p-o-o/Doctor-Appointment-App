...
class SymptomsView: UIView {
    ...
    init(userId : String,height : CGFloat,width : CGFloat ) {
        self.height = height
        self.width = width
    ...
    func setHeader(){
        ...
        NSLayoutConstraint.activate([
            ...
            title.heightAnchor.constraint(greaterThanOrEqualToConstant: height * 0.15),
        ...
        NSLayoutConstraint.activate([
            ...
            viewAll.heightAnchor.constraint(greaterThanOrEqualToConstant: height * 0.15),
    ...
    func setCollectionView(){
        ...
        NSLayoutConstraint.activate([
            ...
            collectionView.heightAnchor.constraint(greaterThanOrEqualToConstant: height * 0.83),
...
extension SymptomsView : UICollectionViewDataSource ,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let viewController = ViewDepartment(userId: patient.UserId,department: Department.General_Physician.departmentName)
