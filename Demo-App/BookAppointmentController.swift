...
//        textView.layer.borderColor = UIColor.black.cgColor
  ...
  let genderPickerView = UIPickerView()
    ...
    func setViews(){
        ...
        doctorInformationView.backgroundColor = .white
        patientDetailsView.backgroundColor = .white
        appointmentTimingsView.backgroundColor = .white
        billDetailsView.backgroundColor = .white
    ...
    func setBookingView(){
        ...
        NSLayoutConstraint.activate([
            ...
            bookingView.heightAnchor.constraint(equalToConstant: Viewheight * 0.15),
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row != 0 {
            for index in 1...details.count{
                ...
                labelAndField.errorLabel.removeFromSuperview()
...
extension BookAppointmentController : UITextFieldDelegate {
